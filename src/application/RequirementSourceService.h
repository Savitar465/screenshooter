...
public:
    ...
    /// Descarga un adjunto de la ficha con los ajustes actuales.
    void downloadAttachment(const RequirementAttachment& attachment, std::function<void(const RequirementAttachmentResult&)> done);
